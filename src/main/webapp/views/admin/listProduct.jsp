...
<%
	if(session.getAttribute("adminname") == null){
		response.sendRedirect("/FiShop/views/admin/login.jsp");
	}
%>
<body>
			...
			<div class="row">
				<div class="card">
					<div class="card-body">
						...
						<a href="/FiShop/list-product?pId=2" class="link-danger">Sneakers||</a>
						...
						<tbody>
							<c:forEach items="${requestScope.products }" var="cate">
								<tr>
									...
									<td style="width: 16.667%;"><img style="width:100px;height:100px;" class="img-fluid w-100" src="${cate.pImg }" alt=""></td>
									<td style="width: 10%;">${cate.quantity }</td>
									<td><a href="updateProduct?pId=${cate.pId }"><i
											class="fa-solid fa-pen-to-square"></i>|</a> <a href="#"
										onclick="deleteProduct('${cate.pId}')"><i
