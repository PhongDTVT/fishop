		...
		<ul class="sidebar-nav" id="sidebar-nav">
			...
			<li class="nav-item"><a class="nav-link collapsed"
				...
				<ul id="components-nav" class="nav-content collapse "
					...
					<li><a href="components-accordion.html"> <span>Danh
								sach loai san pham</span>
					</a></li>
					<li><a href="components-badges.html"> <span>Badges</span>
					</a></li>
					<li><a href="components-breadcrumbs.html"> <span>Breadcrumbs</span>
					</a></li>
					<li><a href="components-buttons.html"> <span>Buttons</span>
					</a></li>
					<li><a href="components-cards.html"> <span>Cards</span>
					</a></li>
	...
	<main id="main" class="main">
		...
		<section class="section dashboard">
			<div class="row">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title">Danh sach loai san pham</h5>

						<button type="button" class="btn btn-primary"
							data-bs-toggle="modal" data-bs-target="#exampleModal"
							data-bs-whatever="@mdo">Them moi san pham</button>
							
						<a href="/FiShop/list-product" class="link-danger">All  ||</a>
						<a href="/FiShop/views/admin/list-sneaker.jsp" class="link-danger">Sneakers||</a>
						<a href="/FiShop/views/admin/list-clothing.jsp" class="link-danger">Clothing||</a>
						<a href="/FiShop/views/admin/list-skateboard.jsp" class="link-danger">Skateboard</a>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="/FiShop/add-product" method="post">
											...
											<div class="mb-3">
												Loai SP:<input type="text" name="loaisanpham_idt" class="form-control" id="recipient-name">
											</div>
											<div class="mb-3">
					...
					<table class="table" id="myTable">
						...
						<tbody>
								...
								<c:forEach items="${requestScope.products.categoryID ==2 }" var="cate">
						
						
										<tr>
										
									<td style="width: 10%;">${cate.pId }</td>
									<td style="width: 16.66%;">${cate.pName }</td>
									<td style="width: 16.667%;">${cate.price }</td>
									<td style="width: 25%%;">${cate.pDesc }</td>
									<td style="width: 16.667%;">${cate.pImg }</td>
									<td style="width: 10%;">${cate.quantity }</td>
									
									<td><a href="updateCategory?pId=${cate.pId }"><i
											class="fa-solid fa-pen-to-square"></i>|</a> <a href="#"
										onclick="deleteCategory('${cate.pId }')"><i
