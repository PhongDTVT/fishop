...
<body>
				...
				<div class="card">
					<div class="card-body">
						...
						<button type="button" class="btn btn-primary"
							...
							data-bs-whatever="@mdo">Thông tin đặt hàng</button>
						...
						<tbody>
							...
							<c:forEach items="${requestScope.ods }" var="od">
							<c:forEach items="${requestScope.uId }" var="uId">
							<c:if test="${od.userId == uId }">
								<tr>
								
									<td style="width: 10%;">${od.order_id }</td>
									<td style="width: 10%;">${od.sanpham_id }</td>
									<td style="width: 10%;">${od.pName }</td>
									<td style="width: 12%;"><img style="width:50px;height:80px;" class="img-fluid w-100" src="${od.pImg }" alt=""></td>
									
									<td style="width: 10%;">${od.quantity }</td>
									<td style="width: 10%;">${od.size}</td>
									<td style="width: 16.667%;">${od.userId }</td>
						...
						<tbody>
							<c:forEach items="${requestScope.users }" var="u">
								<tr>
									...
									<td style="width: 16.66%;">${u.fullName }</td>
									<td style="width: 16.667%;">${u.userName }</td>
									<td style="width: 25%%;">${u.passWord }</td>
									<td style="width: 16.667%;">${u.email }</td>
									<td style="width: 16.667%;">${u.phoneNumber }</td>
									<td style="width: 10%;">${u.address }</td>
									<td> <a href="#"
										onclick="deleteUser('${u.id}')"><i
											class="fa-solid fa-trash"></i></a>||
										<a href="#"
										onclick="deleteUser('${u.id}')"><i class="fa-sharp fa-light fa-circle-info"></i></a>
											</td>
	...
	<script type="text/javascript">
  	function deleteProduct(uId) {
		...
		if(answer){
			window.location = "deleteProduct?pId=" + uId;
		}
	}
  </script>
	<script type="text/javascript">
