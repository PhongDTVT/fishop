...
<body>
				...
				<div class="card">
					<div class="card-body">
						...
						<button type="button" class="btn btn-primary"
							...
							data-bs-whatever="@mdo">Xem số lượng tồn kho</button>
						...
						<tbody>
							<c:forEach items="${requestScope.s }" var="s">
								<tr>
									...
									<td style="width: 10%;">${s.pId }</td>
									<td style="width: 16.66%;">${s.pName }</td>
									<td style="width: 16.667%;">${s.price }</td>
									<td style="width: 25%%;">${s.discount }</td>
									<td style="width: 16.667%;"><img style="width:100px;height:100px;" class="img-fluid w-100" src="${s.pImg }" alt=""></td>
									<td style="width: 10%;">${s.tonkho }</td>
					...
					<table class="table" id="myTable2">
						...
						<tbody>
							<c:forEach items="${requestScope.qs }" var="qs">
								<tr>
								
									<td style="width: 10%;">${qs.pId }</td>
									<td style="width: 10%;">${qs.quantity }</td>
									<td style="width: 10%;">${qs.quantitySell }</td>
									<td style="width: 10%;">${qs.pName }</td>
									<td style="width: 16.667%;">${qs.price }</td>
									<td style="width: 10%;">${qs.discount }%</td>
									<td style="width: 12%;"><img style="width:50px;height:80px;" class="img-fluid w-100" src="${qs.pImg }" alt=""></td>
									
									<td> <a href="#"
										onclick="deleteOrderDetail('${qs.pId}')"><i
	...
	<script type="text/javascript">
  	function deleteOrderDetail(orderId) {
		...
		if(answer){
			window.location = "deleteOrderDetail?oId=" + orderId;
		}
	}
  </script>
	<script type="text/javascript">
