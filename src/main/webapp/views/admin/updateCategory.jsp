  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
      	<div class="card">
      		<div class="card-body">
      			<h5 class="card-title">Cap nhat loai san pham</h5>
      			<c:set var="cate" value="${requestScope.category }"></c:set>
      			<form action="/FiShop/updateCategory" class="row g-3" method="post">
      				<div class="col-12">
      					<label>Ma san pham</label>
      					<input type="text" readonly="readonly" value="${cate.id }" name="id" class="form-control"/>
      				</div>
      				<div class="col-12">
