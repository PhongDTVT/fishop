        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-alerts.html">
            	<span> <a href="/FiShop/list-category1" onclick="danhmucsp(event)">Danh muc san pham</a> </span>
            </a>
          </li>
          <li>
            <a href="components-accordion.html">
              <span> <a href="/FiShop/list-product" onclick="danhsachsp(event)">Danh sach loai san pham</span>
            </a>
          </li>
          <li>
...
<!-- End #main -->
  ...
  <script type="text/javascript">
  	function danhmucsp(event) {
		event.preventDefault();
		window.location.href = "/FiShop/list-category1";
	}
  </script>
  <script type="text/javascript">
  	function danhsachsp(event) {
		event.preventDefault();
		window.location.href = "/FiShop/list-product";
	}
  </script>
